// This is a template or a blueprint

class Flower {
    // // this function inside class (no 'function' prefix)
    // // constructor is needed
    // constructor() {
    //     // We write instructions to set up a Flower here
    //     // Position and size information
    //     // 'this' is only for this object
    ...
    constructor(x, y, size, stemLength, petalColor) {
        ...
        // keep a copy of 'this' to a var
        let self = this;

        this.flowerStemDiv.addEventListener("click", growStem);

        function growStem(e) {
            console.log(self.stemLength); // not this.stemLength
