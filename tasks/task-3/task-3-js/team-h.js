...
function setup_H() {
  ...
  /**************************************************** */
  //get the buttons
  activateButtons(`#TEAM_H`, "ani_canvH",aniA,aniB,aniC);
  ...
  function aniB(parentCanvas) {
    ...
    let sampleColors = ["red","purple","orange","magenta","black","white","green","yellow","pink","lime","maroon","teal","navy","olive","grey","fuchsia",];
